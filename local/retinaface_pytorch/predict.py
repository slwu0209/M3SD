...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------#
    video_path      = '/disk5/chime/mm/data/meeting1/segment/00940/video/00940-Scene-011.mp4'
    video_save_path = "/disk5/chime/mm/local/retinaface-pytorch/test"
    video_fps       = 25.0
    #-------------------------------------------------------------------------#
    ...
    if mode == "predict":
        ...
        while True:
            ...
            if image is None:
                ...
                cv2.imwrite('/disk5/chime/mm/local/retinaface-pytorch/test.jpg', r_image)
                cv2.waitKey(0)
